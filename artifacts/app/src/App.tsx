...
import {
  ...
  Pin, Plus, Search, Send, Settings, ShieldCheck, SmilePlus, Sun, Trash2, UserPlus, Video, Volume2, X, Edit3
} from 'lucide-react';
...
function ChatList({ chats, selected, onSelect, onSettings, onAdd, mobileList }: { chats: Chat[]; selected: string; onSelect: (id: string) => void; onSettings: () => void; onAdd: () => void; mobileList: boolean }) {
